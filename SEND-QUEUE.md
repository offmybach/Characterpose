...
I wrote the spending book — one kid, one purchase, the whole way from the sale ads at the kitchen table to the sales tax on the receipt. Sixteen-plus concepts, none announced, and a twenty-one-term glossary in the back where every entry points back to the page it happened on. It's catalogued Lexile AD 620L, Adult Directed, so a parent who doesn't feel qualified on money still gets handed the script.
...
I built the K-5 piece. A 36-page picture book following one complete purchase — sale ads at the kitchen table, comparison on a shelf, a markdown taken on purpose, a coupon at the register, sales tax, and living with what was bought. Sixteen-plus concepts, none announced; nobody in it says the word "budget." A twenty-one-term glossary in the back, page-referenced to the scene each term came from.
...
And on page 6 there's something I haven't found in another picture book: a 529 plan. In the plot. Explained by a mother, eye-rolled at by a kid, defended by a father two scenes later. Hand it to a client family and that conversation starts itself at their kitchen table, on their schedule, with their kid asking.
...
I wrote the spending book. Clarence Gets a Bargain, ages 6–10, follows one complete purchase the whole way, from the idea to after the receipt: sale ads at the kitchen table, comparison on a shelf, a markdown taken on purpose, a coupon at the register, sales tax, and living with the choice. Sixteen-plus concepts, none announced, and a twenty-one-term glossary page-referenced back into the story.
...
I wrote the picture book version. One kid, one complete purchase, from the sale ads at the kitchen table to the sales tax on the receipt. Sixteen-plus concepts, none announced. A twenty-one-term glossary in the back, page-referenced to the story. Catalogued Lexile AD 620L — Adult Directed — read with a grown-up rather than handed over.
...
Clarence Gets a Bargain is a 36-page picture book, ages 6–10, that follows one complete purchase: reading the sale ads at the kitchen table, comparing two models on a shelf, taking the marked-down one on purpose, handing a coupon to the cashier, paying the tax, and living with the choice. Sixteen-plus concepts, none announced. A twenty-one-term glossary in the back, page-referenced to the scene each came from.
