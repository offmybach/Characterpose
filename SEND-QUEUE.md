...
**Paste as plain text.** `Ctrl+Shift+V` on Windows, `Cmd+Shift+V` on Mac. Gmail's polish tool
rewrote a sent letter last week — "hand them over" became "share them" and it closed up the
em dashes. Decline every "help me write" suggestion.

**Never round a figure.** $25 · $9.99 · $293 · $69.50 · $19.99 · $499.75 · $14.

**Pace.** Ten to fifteen LinkedIn messages a day is comfortable. The point is replies, not
volume — leave yourself room to answer whoever writes back.
...
## ✅ Already gone — do not re-send

- The six **grandparent letters** (GRAND, More Than Grand, Generations United, Ron Lieber,
  Cool Grandpa, the reusable one). Checked against every invariant: zero defects.
- The **specific-person letters from last week** — Delaware, MAESP/NAESP, Mia Russell,
  Edoho-Eket. Full text still lives in `letters-delaware.md`, `letters-maesp-naesp.md`,
  `letter-mia-russell.md`, `letter-edoho-eket.md` if you need to check what you said.

## 📦 Owed from those — do these first, they cost nothing

- [ ] **Mail DeeDee Moore a hardback.** You wrote "I'll mail you a hardback this week."
- [ ] **Mail Greg at Cool Grandpa a copy.** You wrote "I'll send a copy either way."

An unkept promise in a first email costs more than the book does.

---

# WEEK 1 — 14 letters

The time-boxed ones and the highest value. Bonner opened the door himself; August is library
order season; and Stephen Day has the longest lead time of anyone here.

---

## 1. Dr. Erikk D. Bonner
*Assistant State Superintendent, Maryland State Dept of Education*

**Channel:** LinkedIn message (1st-degree)  
**Source:** `letter-erikk-bonner.md`

- [ ] sent

```
Erikk — thanks for the note, and good to be connected. I'm a Maryland attorney who also writes and illustrates children's books, so I'm coming at your world sideways.

A question I can't get a straight answer to, and you would actually know.

As I read it, Maryland has required a program of financial-literacy instruction at the elementary level since the State Board's 2010 regulations — not just high school. HB 943 now adds the graduation course for the class of 2030. So the high school end is getting a course, a credit, and a reporting line. What does the elementary end have?
...
## 2. Stephen Day
*Author of "Teach a Kid to Save" · Director, VCU Center for Economic Education*

**Channel:** LinkedIn message (1st-degree)  
**Source:** `letters-new-aug.md`

> The most important name on this list, and the most delicate.
...
So I wrote the other half. Clarence Gets a Bargain follows one purchase the entire distance — a boy wants a robot, earns it with chores and grades, reads the newspaper sale inserts at the kitchen counter, compares two models on a shelf, takes the marked-down one on purpose, hands a coupon to the cashier, meets sales tax, and then lives with what he chose. Idea to post-receipt.

Sixteen-plus concepts and not one is announced; nobody in the book says the word "budget." A kid doesn't work out he's been schooled until he reaches the glossary — twenty-one terms in the back, each page-referenced to the scene it came from. Catalogued Lexile AD 620L, Adult Directed, so it runs as a one-period read-aloud and a teacher with no finance background can deliver it cold. Free ungated classroom set behind it, mapped against five frameworks including CEE.

Two questions, and the first one matters more. Does the sequence hold up against what you see in classrooms, or is there a reason the field starts where it starts? And is there any version of this that belongs near the work your center does?

I'd trade copies gladly. I'll read yours properly rather than politely.
...
Kids re-read it without being asked, which is the only metric that counts at your desk. Shelve it under picture books; file it under secret weapons. Review copy on request?
...
## 4. Johanna Arnone
*Managing Editor, NerdWallet · Content Strategy*
...
Meanwhile the environment isn't waiting. A boardwalk claw machine takes $25 to hand back a basketball that Walmart sells for $9.99, and the kid has no price memory to defend himself with. Once a kid has seen the $9.99, the claw loses its grip. Nobody shows them the $9.99.

I wrote the spending book — one kid, one purchase, the whole way from the sale ads at the kitchen counter to the sales tax on the receipt. Sixteen-plus concepts, none announced, and a twenty-one-term glossary in the back where every entry points back to the page it happened on. It's catalogued Lexile AD 620L, Adult Directed, so a parent who doesn't feel qualified on money still gets handed the script.

The piece I'd pitch NerdWallet isn't the book. It's the forty-year hole: an entire publishing category taught children to save and skipped the cash register, which is the only place a child has ever actually handled money.

Anything there? clarencegetsabargain.com/book-facts.html
...
## 5. Billy Mills
*Financial literacy content consultant — reviews and audits curriculum content, mentors teachers, tutors students. Former standalone Financial Literacy middle school teacher.*

**Channel:** LinkedIn message (1st-degree)  
**Source:** `letters-new-aug.md`

> He audits curriculum for a living.

- [ ] sent

```
Billy — you audit financial literacy curriculum for a living, which makes you exactly the wrong person to send marketing to and exactly the right person to ask for a teardown.
...
Catalogued Lexile AD 620L — Adult Directed — one class period, no teacher training required.

What I actually want: tell me where it fails an audit. I'd rather hear it from you than from a district that already adopted it.
...
## 6. Vicky Reynal
*Financial Psychotherapist · Author · Speaker · Columnist*

**Channel:** LinkedIn message (1st-degree)  
**Source:** `letters-new-aug.md`

> The best thesis overlap on this list after Day.

- [ ] sent

```
Vicky — you work on the emotional side of money, which is the half the children's literature pretends doesn't exist.

Every kids' money book teaches saving — a rational act, framed as a virtue, taught as restraint. Not one of them addresses the moment where the feeling actually happens: a child in a store, holding money, wanting something. Saving is the second thing a child does with money. The first is spending, and it is entirely emotional.

I'll give you my own evidence. Sleepaway camp, four-week session, one deposit in my canteen account and no adult standing behind me. My bunkmates bought a candy bar and maybe a soda. I bought a handful of Blow Pops, at least one pack of Fun Dip and usually a soda, every visit, because I thought that was what being cool looked like. Halfway through week three the account hit zero and I spent the last week and a half watching everybody else buy candy. Nothing about that was a maths failure.

So I wrote the spending book. Clarence Gets a Bargain follows one purchase the whole way — wanting the thing, earning it, the sale ads at the kitchen counter, two models compared on a shelf, the cheaper one taken on purpose, a coupon at the register, sales tax, and living with the choice afterward. Sixteen-plus concepts, none announced; nobody says "budget." A twenty-one-term glossary in the back, page-referenced to the scene each term came from.

It's catalogued Lexile AD 620L — Adult Directed — so it's read with a grown-up rather than handed over, and the interruptions are the product.

The question I'd most like your read on: is the wanting the thing we should be teaching children to examine, rather than the restraining? I think it is, and I'd like to be argued with.
...
## 7. Shamim Okolloh
*Banker · Author · Founder, Ella The Banker*
...
```
Shamim — author to author, and founder to founder. You built Ella The Banker because the thing you wanted didn't exist. I did the same on a different shelf.

I went looking for the children's book that teaches a kid how to spend money — not save it, spend it — and there wasn't one. Every book in the category is a piggy bank or a lemonade stand. Forty years of them, and not one has ever been to a store. Saving is the second thing a child does with money; the first is spending, and a six-year-old has already done it, holding money in a store, deciding whether the thing is worth what it costs.

So I wrote and illustrated it. Clarence Gets a Bargain, ages 6–10: a boy earns a robot with chores and grades, works the sale inserts at the kitchen counter, compares two models on a shelf, takes the marked-down one on purpose, hands a coupon to the cashier, meets sales tax, and then lives with what he chose. Idea to post-receipt.

The craft problem I'd most like another author's view on: sixteen-plus concepts and not one of them is announced. Nobody says "budget." The reader doesn't work out he's been taught anything until he reaches the glossary — twenty-one terms in the back, each page-referenced to the scene it came from. Keeping it a story was the whole job, and it's the thing most likely to be off by a hair.

I did the illustrations too, which means my opinion of them is worth nothing.

Catalogued Lexile AD 620L — Adult Directed — written for the adult voice in the room.

Trade copies? I'll read Ella properly and tell you the truth about it, which is the only thing worth trading.
...
## 8. Brad Siegel
*Superintendent, Mountain Lakes School District (NJ)*
...
```
Brad — a question about the elementary end of financial literacy, from someone who built for it and can't find anyone who owns it.

Every state requirement lands in high school. New Jersey's included. The elementary standards sit underneath with almost nothing built against them, for the least respectable reason available: nobody has to report on that band. Meanwhile the habits a high school course is trying to correct were installed at six, in a store, with a parent saying no.
...
Who in your district owns elementary financial literacy, if anyone does? Happy to walk a curriculum team through it, or a single school if that's the right size to start.
...
The distinction matters most where there is no margin. Teaching a child only to save is advice that assumes surplus. A child who can compare two prices and choose deliberately has a skill that works this Saturday, in the household as it actually is.

Clarence Gets a Bargain follows one purchase the whole distance — the sale ads at the kitchen counter, two models on a shelf, the marked-down one taken on purpose, a coupon at the register, sales tax, and living with what was chosen. Sixteen-plus concepts, none announced; nobody says "budget." A twenty-one-term glossary in the back, page-referenced to the story.
...
> Tier C — deadpan. No P.S., no claw machine.

- [ ] sent

```
Eric — a scope question rather than a pitch.

Federal and state attention to financial education concentrates on high school. Thirty states now require a course to graduate. The elementary standards that exist in most states sit underneath that with very little built against them, largely because nothing requires reporting at that band.
...
## 11. Faye Griffiths-Smith
*Financial Education Outreach throughout Connecticut · UConn Extension*
...
```
Faye — Extension reaches families where a school district never does, which is why I'm asking you rather than a curriculum director.

Most financial education aimed at children teaches saving. Saving is the second thing a child does with money; the first is spending, and a first grader has already done it at a register. There is almost nothing to hand a family about that moment.

Clarence Gets a Bargain is a 36-page picture book following one complete purchase: a boy wants a robot, earns it with chores and grades, reads the sale inserts at the kitchen counter, compares two models on a shelf, takes the marked-down one on purpose, hands a coupon to the cashier, meets sales tax, and lives with the choice. Sixteen-plus concepts and nobody in it says the word "budget." A twenty-one-term glossary in the back, each entry page-referenced to the scene where it happened.

Why it fits an Extension model specifically: it's catalogued Lexile AD 620L — Adult Directed — about twenty minutes out loud, with every concept explained inside the text by the mother. An educator or a volunteer can read it cold and field questions straight off the page. No training call, nothing to memorise. Everything behind it is free and ungated — lesson plans, assessments with answer keys, printable price tags and clearance stickers for a pretend store, a browser-based register — and it prints from a browser, which matters where there is no budget line.

Two family games from the book need more than one player, which makes them usable at any Extension event: a grocery savings hunt where the loser carries the bags in, and a price-guessing game after dinner.

Does elementary sit inside what your outreach covers, or does it start later? Free either way.
...
## 12. Ryan Decker, PhD, CFP®
*Professor · Financial Educator*
...
```
Ryan — you teach this at the level where students arrive with habits already formed, so you'll know whether my premise holds or whether I'm inventing a problem.

The premise: financial education starts children with saving, and the sequence is backwards. Saving is the second thing a person does with money. The first is spending — a first grader has no savings rate and has already stood at a register and chosen. By the time a student reaches your classroom the pattern is fifteen years old.

The cost of learning it late, stated the way I'd put it on a poster: mistakes at eleven cost $14, and the same mistake at twenty-seven has a credit card attached.

I wrote the elementary piece rather than an argument about it. Clarence Gets a Bargain follows one complete purchase — sale ads at the kitchen counter, two models compared on a shelf, the marked-down one taken deliberately, a coupon at the register, sales tax, and living with the choice. Sixteen-plus concepts, none announced. A twenty-one-term glossary in the back, page-referenced to the scene each term came from. Catalogued Lexile AD 620L — Adult Directed — a one-period read-aloud with no teacher training required, and a free ungated classroom set crosswalked to five frameworks.

The question I'd actually value: does anything you see in students suggest that price competence at seven shows up at twenty-seven? If it doesn't, I'd rather know than keep saying it.
...
## 13. Sara Lorenzen, M.Ed., CFEI®, AFC® Candidate
*Financial Wellness Leader · Conference Speaker*
...
```
Sara — a CFEI knows what actually teaches versus what only informs, so this is a question about the bottom of the age range rather than a pitch.
...
Does elementary come up in the rooms you speak in as something people want and can't find? I'm trying to work out whether I'm filling a gap or inventing one.
...
## 15. Roda Ducommun
*Founder, Smart Money Kids World TV · Creator of The 30-Day Smart Spending Challenge · 1st-degree*

**Channel:** LinkedIn message (1st-degree)  
**Source:** `letters-top25-week1.md`

> The best thesis overlap on the entire list — she already built a spending program.

- [ ] sent

```
Roda — you built a 30-Day Smart Spending Challenge. Not a saving challenge. Spending. As far as I can tell that makes two of us in this entire category who think the sequence is backwards.
...
## 16. Cinders McLeod
*Moneybunnies · the direct shelf-mate · 1st-degree*
...
## 17. Tami Lehman-Wilzig
*Award-winning children's picture book author · 1st-degree*
...
```
Tami — author to author, and I'd rather you heard this from me than found it on a shelf.
...
## 18. ML Bruin
*Award-winning children's author · creator of the "Noah" series · 1st-degree*
...
```
ML — you built a series a child comes back to, which is harder than writing one good book, and it's the reason I'm writing to a peer rather than a gatekeeper.
...
## 19. Nicolle Hood
*CEO, My First Nest Egg · her roundup ranks for your category keywords · 1st-degree*
...
```
Nicolle — your twelve-book roundup is the one I point people to, which is slightly awkward, because every title on it teaches earning or saving.
...
## 20. Linda Simpson
*Financial Parenting Educator · Professor · Anchord Money · 1st-degree*

**Channel:** LinkedIn message (1st-degree)  
**Source:** `letters-top25-week1.md`

> Highest score on the entire list.

- [ ] sent

```
Linda — you teach financial parenting, which means you spend your working life on the exact handoff I wrote a book about: the moment a parent has to explain money to a child who is standing right there wanting something.
...
## 21. Daniel Hagadorn
*Founder, 360 Parenting · Speaker, author, podcaster · 1st-degree*

**Channel:** Email — `dh@PK4L.com`  
**Source:** `letters-top25-week1.md`

- [ ] sent

```
Daniel — you built 360 Parenting around the whole child rather than one slice of them, so this is a slice you may be missing, and I say that as someone who only noticed it because I went looking for a book and could not find one.
...
## 22. Paula Pant
*Afford Anything · 45M downloads · 1st-degree*
...
## 23. Kim Childress
*Children's publishing — award-winning editor and reviewer · 1st-degree*
...
```
Kim — you review children's books for a living, so you have read more well-meaning money picture books than anyone should have to, and you already know the problem with them.
...
## 26. Alex Goldmark
*Executive Producer, Planet Money, NPR · 1st-degree*
...
> Tier C — deadpan. This is a procedural ask, not a bit.
...
> Tier C — deadpan. She owns the shelf; ask about the shelf.

- [ ] sent

```
Lyn — a direct question about the Money as You Grow Bookshelf, from someone who has read what's on it.
...
```
Tracy — a public-private partnership is how a K-5 resource actually reaches classrooms, because elementary rarely gets its own budget line. That is the whole reason I'm writing to you rather than to a district.
...
> Tier B — dry. He works on policy; give him the policy shape of it.

- [ ] sent

```
Hunter — a policy observation, and a question about whether NEFE has a view on it.
...
```
Tim — NGPF owns 9-12 and does it better than anyone, so take this as a question about the floor beneath your work rather than a pitch into your territory.
...
researchers, then the institutions that reply slowest — send those early for that reason.
...
**Channel:** LinkedIn message (1st-degree)  
**Source:** `letters-whales-longform.md`

- [ ] sent

```
Sam — you have been reading, singing and performing a savings habit into elementary classrooms for two decades across thirty states, which is more direct contact with this audience than anyone else in the category has. So I want to put an argument in front of you and hear where it is wrong.
...
That is the book I wrote. Clarence Gets a Bargain follows one purchase the whole way: a boy wants a robot, earns it with chores and grades, reads the newspaper sale inserts at the kitchen counter, compares two models on a shelf, takes the marked-down one on purpose, hands a coupon to the cashier, meets sales tax, and then lives with what he picked. Sixteen-plus concepts, none announced. The kid does the math because the robot depends on it. A twenty-one-term glossary in the back, page-referenced to the scene each term came from. Catalogued AD 620L — Adult Directed — about twenty minutes out loud, every concept explained inside the text, so somebody can read it cold to a class. You of all people will know why that mattered to me. The rest of the shelf is piggy banks with plots. Good ones, some of them — but none of them has ever been to a register. Teach the spending moment first and everything those books preach lands harder.
...
```
Prince — you took investing, which is the hardest concept in this category to make readable for children, and made it a series a kid comes back to. I went the opposite direction on the same shelf and I would like your read on it.
...
```
Annie — you built a product for the exact age band everyone else in this category skips, so you already believe the thing I have been arguing. I want to compare notes rather than pitch you.
...
```
Tom — you got more genuine engagement out of one post about kids and money than anyone else in this category has managed, which tells me you know exactly which part of this parents actually care about. I would like to check my premise against that.

My premise: the whole field has the sequence backwards. Financial education starts children with saving. Saving is the second thing a child does with money. The first is spending, and a six-year-old has already done it, standing in a store holding a birthday five-dollar bill, working out whether the thing is worth what it costs. We teach the second thing first and the first thing never.
...
```
Lynnette — you have spent a career telling people the truth about money in language they can actually use, and you built a network for people doing the same. I wrote the six-year-old version and I would like your read on whether it lands.
...
```
Rob — you build resources teachers actually use, which is a harder job than writing curriculum and a rarer one. I built the elementary thing that does not exist, and I want a practitioner's read on whether it survives a real classroom.
...
```
Kim — you cover retail, so you already know the boardwalk arcade is a pricing strategy rather than a game. I wrote the children's book that explains it before a kid loses to it.
...
```
Amanda — Planet Money's whole trick is that people will sit still for an economics lesson if it is hidden inside a story about a person and a thing. I did that at a first-grade reading level, and I am writing about the story rather than the book.
...
```
Terry — you have been telling adults the truth about money for decades, usually after the damage is done. I wrote the book for about twenty years earlier than you usually get them.
...
```
Beth — you write for people trying to do the right thing with money and finding the advice arrives late. This arrives about two decades earlier than most of it.
...
```
Kate — a pitch about a gap rather than a book, though I wrote the book because of the gap.
...
```
Andrew — your audience is adults fixing money habits. I wrote the book that tries to stop the habits forming, and there is an episode in the argument whether or not the book is in it.
...
```
Julie — a segment idea, and it is short enough to survive a live hit.

Every children's money book teaches saving. Piggy banks, lemonade stands, jars. But saving is the second thing a child does with money — the first is spending, and a six-year-old has already done it, in a store, holding a birthday five-dollar bill, deciding whether the thing is worth what it costs.
...
```
Matt — you spend your working life on what happens when people meet credit without the groundwork. I wrote the book about the groundwork, roughly twenty years upstream of your data.
...
```
Gretchen — you have spent a career on how financial products get sold to people who don't fully understand them. Here is the entry-level version of that, and nobody covers it.

A child becomes a consumer the first time money leaves their hand. Six years old, a birthday five-dollar bill, a store. From that moment they are a party to transactions, and the entire financial education apparatus treats them as a saver in training instead. We teach them to hold money. Nobody teaches them what happens when they use it, which is the only thing they were ever going to do with it.
...
I wrote the picture book for it. One kid, one purchase, followed the whole way: he wants a robot, earns it, reads the newspaper sale inserts at the kitchen counter, compares two models on a shelf, takes the cheaper one on purpose, hands over a coupon, meets sales tax, and lives with what he chose. Name another picture book where the kid reads the sale ads before the trip, compares models in the aisle, hands over a coupon, and pays the sales tax. Idea to post-receipt; sixteen-plus concepts and nobody in the book says the word "budget." The child works out he has been schooled only when he reaches the glossary — twenty-one terms in the back, each page-referenced to where it happened. It is catalogued Lexile AD 620L, where AD stands for Adult Directed — the trade's own code for a book an adult reads with a child rather than hands over.
...
```
Ben — a story pitch about a gap in the coverage rather than a book pitch, though the book is how I found it.
...
There is a moment where he hands the cashier an extra ten-percent-off coupon like a tiny attorney presenting Exhibit A. I am an attorney, and on vacation that mostly means the souvenirs get cross-examined. The hermit crab: who feeds it over the holidays, and in two weeks when it dies — and buddy, it will — is it worth the tears? My kids find this insufferable. It is also the entire skill.
...
```
Veronica — you cover how families hold on to money across generations, which is why I am writing about the earliest possible end of that.
...
```
Amy — two requests come to your desk all week. A kid wants a robot book. A parent wants something that teaches money. I wrote the one that answers both in a single checkout.
...
```
Sarah — a collection-development pitch, kept to the facts because I know what August looks like at your desk.
...
```
Professor Urban — you produced the evidence base that mandates actually work, which is why I want to ask about the grade band your evidence does not reach.
...
**Channel:** LinkedIn message (1st-degree)  
**Subject:** `Applied micro, twenty years early`  
**Source:** `letters-whales-longform.md`
...
```
Susan — you built a center from nothing and have spent years getting economics into elementary classrooms, which makes you exactly the person to tell me whether I am filling a gap or inventing one.
...
```
Beth — a research question rather than a pitch, and the book is only the reason I ran into it.
...
> Tier C — deadpan. No bit.

- [ ] sent

```
Jeff — a question about scope, from someone who has read the SHED closely enough to know what it does and does not ask.
...
> Tier C — deadpan. She runs the clearinghouse; respect the process.

- [ ] sent

```
Laura — a question about scope rather than a pitch, and I have already read the Clearinghouse criteria closely enough to know which route applies to me.
...
> Tier B — dry. He is a researcher running an institution; give him both.

- [ ] sent

```
Billy — a question about where NEFE draws the line on grade band, asked by someone who has just spent a year building for the band nobody funds.
...
```
Ruben — CEE's standards are one of the five frameworks I crosswalked against, so I have spent real time inside them and want to ask about the bottom of the ladder.
...
```
Martin — you sit where the profession decides what it is responsible for, so this is a question about the far upstream end of that responsibility.
...
The field's answer to that is to teach children saving. But saving is the second thing a child does with money. The first is spending, and a six-year-old has already done it, holding a birthday five-dollar bill, deciding whether the thing is worth what it costs.

I wrote the picture book for that moment. Clarence Gets a Bargain follows one purchase the whole way — earning the reward through chores and grades, working the sale ads at the kitchen counter, comparing two models on a shelf, taking the cheaper one on purpose, redeeming a coupon, meeting sales tax, and then living with what was bought. Idea to post-receipt. Sixteen-plus concepts, none announced. Twenty-one terms in a back-matter glossary, page-referenced to the story. A course at fifteen for a habit set at six is not early intervention; it is a receipt.
...
```
Vince — you have thousands of instructors in the field, which means you know better than almost anyone what they walk into a room without. I built the elementary thing they do not have.
...
```
Bill — a question about grade band from someone who has read what states actually fund.
...
So I built the grades 1-5 piece. A 36-page picture book that follows one purchase from the idea to after the receipt — sale ads at the kitchen counter, comparison shopping on a shelf, a markdown taken on purpose, a coupon at the register, sales tax, and living with what was bought. Sixteen-plus concepts, none announced. A twenty-one-term glossary page-referenced into the story. There is a whole industry aimed at teenagers who already have the habit, and almost nobody upstream of it.
...
```
Bethann — you run the education side of a bankers association, which means you are the person who decides what volunteers actually carry into a classroom. I built something for the grade band most bank programs skip.
...
```
Flora — JA runs volunteers into elementary classrooms better than any organisation in the country, so this is a materials question rather than a pitch.
...
```
Bina — a question about where community development work draws its lower age bound.
...
> Tier C — deadpan. Federal staff; procedural register only.

- [ ] sent

```
Elizabeth — a scope question rather than a pitch.
...
```
Dr. Taylor — I am a Maryland attorney and children's book author writing about the elementary end of financial literacy, which is the end nobody funds.
...
I wrote the grades 1-5 piece. A 36-page picture book following one purchase from the idea through the receipt: sale ads at the kitchen counter, comparison shopping on a shelf, a markdown taken on purpose, a coupon at the register, sales tax, and living with what was bought. Sixteen-plus concepts, none announced. A twenty-one-term glossary page-referenced back into the story.
...
```
Saskia — HCZ built its whole model on the idea that you intervene early and you do not wait for the system to catch up. I built the elementary financial-literacy piece on the same reasoning, and I would like your read on whether it holds.
...
```
Jennifer — a funding-shaped question rather than an ask, and the resource itself is already free.
...
```
Jillian — Intuit for Education is built for high school and does that job well, so this is a question about the floor beneath it rather than a pitch into your territory.
...
# WEEK 5 — the rest of the new connections

⚠️ Four of these have thin LinkedIn headlines. Check each profile and find one specific
thing before sending. If you can't, skip it — an obviously templated letter costs you the
contact.
...
```
Erin — a client-gift idea that opens a conversation you already want to have.

Every children's money book teaches saving. Mine teaches spending, on the argument that saving is the second thing a child does with money and spending is the first — a six-year-old has already stood at a register and chosen. Clarence Gets a Bargain follows one purchase from the idea to after the receipt: sale ads, comparison, a markdown, a coupon, sales tax, and living with what was bought. Sixteen-plus concepts, none of them announced — nobody in the book says the word "budget" — and a twenty-one-term glossary in the back, each entry page-referenced to the scene it came from.

And on page 6 there's something I haven't found in another picture book: a 529 plan. In the plot. Explained by a mother, eye-rolled at by a kid, defended by a father two scenes later. Hand it to a client family and that conversation starts itself at their kitchen counter, on their schedule, with their kid asking.

Catalogued Lexile AD 620L — Adult Directed — so you're handing over a script rather than an assignment. $19.99; twenty-five copies run $499.75, and the educator program behind it is free.

Does a client-gift line exist at your practice, or is that not how Raymond James does it?
...
```
Navya — you scale learning programs nationally, so you'll know immediately whether this has legs or whether elementary financial literacy is unscalable for a reason I haven't found yet.
...
What actually makes a free elementary resource scale rather than get downloaded and forgotten? You've watched that happen more than I have.
...
Catalogued Lexile AD 620L — Adult Directed — read with an adult, so it doubles as family engagement rather than only a classroom asset. Everything behind it is free and ungated.

Does Equitika reach below the teen band, or is that deliberately out of scope? Either answer is useful.
...
```
Nickhil — a question about the floor beneath fintech rather than a pitch into it.

Every product in this space meets a user who already has money habits. Those habits set early — a first grader has stood at a register and chosen, years before an app gets near them. And what exists for children is almost entirely saving, which is the second thing a person does with money. The first is spending, and nobody built for it.

I wrote the picture book version. One kid, one complete purchase, from the sale ads at the kitchen counter to the sales tax on the receipt. Sixteen-plus concepts, none announced. A twenty-one-term glossary in the back, page-referenced to the story. Catalogued Lexile AD 620L — Adult Directed — read with a grown-up rather than handed over.

There's also a free browser-based pretend register behind it: a markdown, a coupon and sales tax, with the total changing in front of the kid. It's the closest thing I have to a product, and it's free.

Does Finora's thinking reach that far down the age range, or does it start where the account does?
...
```
Jasper — you write financial content for a living, so you'll spot immediately whether this is a story or just an author with a book.

Every children's money book teaches saving. Piggy banks, lemonade stands, three jars. I read all 25 on the ABA Foundation's list to be sure. But saving is the second thing a child does with money — the first is spending, and a six-year-old has already done it, in a store, holding money, deciding. Forty years of piggy banks and not one has ever been to a store.

I wrote the spending one: a boy earns a robot, works the sale ads, compares two models on a shelf, takes the marked-down one deliberately, hands a coupon to the cashier, meets sales tax, and lives with the choice. Idea to post-receipt, the whole way. Sixteen-plus concepts and nobody in it says the word "budget." The reader works it out at the glossary — twenty-one terms, each page-referenced to where it happened. It's catalogued Lexile AD 620L — Adult Directed — so it's read with a grown-up rather than handed over.

The angle, if there is one: an entire publishing category skipped the cash register, which is the only place a child has ever actually handled money.

Worth a look? clarencegetsabargain.com/press-kit.html
...
```
Hayley — an Early Years question, and I'd like to know whether the answer differs outside the US.

American financial education for children starts with saving and lands, in policy terms, in high school. What almost nothing addresses is spending. Saving is the second thing a child does with money; the first is spending, years before there's anything to save. A four-year-old in a shop, holding a coin, is already making the decision.

Clarence Gets a Bargain is a 36-page picture book, ages 6–10, that follows one complete purchase: reading the sale ads at the kitchen counter, comparing two models on a shelf, taking the marked-down one on purpose, handing a coupon to the cashier, paying the tax, and living with the choice. Sixteen-plus concepts, none announced. A twenty-one-term glossary in the back, page-referenced to the scene each came from.

Catalogued Lexile AD 620L — Adult Directed — so it runs as a shared read with an adult, which I gather sits close to how EYFS thinks about adult-led and child-initiated learning. The concepts are all inside the text, so a practitioner needs no finance background.

⚠️ It is American in its details — sale ads, sales tax, a US store. Whether that travels to an international British curriculum is exactly what I'd like your read on.
...
# The dates that box things in

- **National Grandparents Day — Sunday 13 September.** GRAND and More Than Grand are already
  sent. If either replies, the article is the ask, not the book.
- **August is library order season.** Jasmine Washington (week 1), Amy Boglarski and Sarah
  Wright (weeks 3–4) are all time-boxed.

# If you only do one thing this week

Send **Stephen Day**. He wrote *Teach a Kid to Save* and directs the VCU Center for Economic
Education — a category peer and an institution in one person, and the only letter here where
a reply changes the argument rather than just the pipeline.