# Kids as consumers with rights — CFPB and where the idea actually lives

The thesis: a child becomes a consumer the first time they spend money, and should share in
the consumer rights everyone else gets — the right to complain, return a broken item, make a
warranty claim, know a receipt is worth keeping. Almost nothing is written for kids on this, and
the book already walks a child through the transaction end to end.

Good idea. Two things have to be right or the outreach misfires.

## Reality check 1 — jurisdiction

CFPB is **consumer financial** products only: loans, banking, credit, debt collection. The
rights you want kids to have mostly sit elsewhere:

| The right | Whose job |
|---|---|
| Return a broken item, warranty claims, "no refunds" isn't always final, deceptive ads | **FTC** — Magnuson-Moss Warranty Act, refund rules, unfair/deceptive practices |
| A dangerous or defective product | **CPSC** |
| Bad food | FDA / USDA / local health |
| Understanding a receipt, price, the financial side of a purchase | **CFPB** — and only this slice |

Pitch CFPB on warranties and bad food and a staffer bounces the whole note as out of scope.
So the CFPB letter stays in their lane — the financial-consumer piece and the book — and
names the other agencies plainly, which reads as someone who did the homework rather than
someone who thinks CFPB runs everything.

## Reality check 2 — CFPB is being gutted right now

Staff down from 1,758 to 1,174 in the March 2026 court filings, budget roughly halved, and
the reductions specifically name Consumer Response/Education — the division youth financial
education sits in. **Money as You Grow Bookshelf is still live** (ages 4–10, book-based,
page updated June 26, 2026), so the door exists, but temper the expectation: a book-for-the-
bookshelf ask is realistic, a policy collaboration is not, and replies may be slow or never.
Send it, then don't wait on it.

## So the play is

1. **CFPB — Leslie Jones.** Money as You Grow is on-mission and she's already your
   connection. Letter 1. The realistic ask is the bookshelf plus a framing conversation, not
   a partnership.
2. **NCLC — Lauren Saunders.** The rights thesis is consumer law, and NCLC is where consumer
   law lives. She connected July 29. This is the better home for the big idea, and Letter 2
   treats it that way.
3. **FTC — optional, say the word.** If you want the returns/warranty piece pursued, the FTC
   Bureau of Consumer Protection's consumer-education office owns it. I'll draft it, but I'd
   see what Saunders says first — she may hand you the right FTC name and save the cold open.

Both letters below are 1st-degree DMs.

---

## 1. 🐋 Leslie Jones
*CFPB — Youth Financial Education · 1st-degree · DM*
**Builds on:** the short Money as You Grow Bookshelf DM already drafted for her in
`letters-1-198.md`. This is the deeper follow-up, not a repeat.
...
## 2. 🐋 Lauren Saunders
*Associate Director, National Consumer Law Center · 1st-degree · DM · connected Jul 29*
**Why her, for this:** the rights thesis is consumer law, not financial education, and NCLC
is the country's consumer-law authority. This is the better home for the big idea than any
agency, and she's a fresh connection who has never heard the pitch.

```
Lauren — we just connected, and I have a question that belongs at NCLC more than anywhere else I can think of.
