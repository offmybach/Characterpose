...
# --- New tags minted from never-flagged clusters (procurement + curriculum) ---
GROUPS["School & district procurement (bulk/PO buyers)"] = {
    "slug": "school-procurement-buyers",
    "subjects": [
        "Bulk copies for your schools: quick question",
        "A title for your shelves, PO-friendly",
        "Class sets of a money book your teachers will actually use",
    ],
    "openers": [
        "You handle the buying{org_clause}, so you are exactly who I should ask.",
        "Here is why I am writing you specifically: {role}{org_clause}.",
        "Given what you purchase{org_clause}, you will know fast if this fits a line item.",
    ],
    "openers_li": [
        "You handle purchasing{org_clause}.",
        "Given what you buy{org_clause}, you will know if this fits.",
    ],
    "email_bodies": [
        "Hi {first},\n\n{opener}\n\nI wrote a children's book, {BOOK}, that teaches real money skills inside a story. A kid earns a robot, then has to shop for it. {fact}\n\nIt comes as class sets with a zero-prep educator toolkit, it is PO-friendly, and it works for Title I and family-engagement budgets. {ask}\n\n{sig}",
        "Hi {first},\n\n{opener}\n\n{BOOK} is a 36-page standards-aligned picture book (Jump$tart, Common Core Math and ELA, CEE) that teaches kids money skills through a Sea-Mart shopping trip. Available in bulk with a purchase order. {ask}\n\n{sig}",
    ],
    "linkedin": [
        "Hi {first}, {opener_li} I wrote {BOOK}, a standards-aligned kids' money book available as PO-friendly class sets with a zero-prep toolkit. Could I send you pricing and a sample?",
        "Hi {first}, quick one. {BOOK} is a money book kids actually finish, available in bulk for districts. Want a sample copy and a bulk quote?",
    ],
    "ask": "Want a sample copy and a bulk quote? I can send pricing for class sets and the free educator toolkit.",
    "role_default": "purchasing lead",
}
GROUPS["Curriculum & instructional-design leaders"] = {
    "slug": "curriculum-id-leaders",
    "subjects": [
        "A narrative money resource for your K-5 curriculum",
        "Where a money story fits in your scope and sequence",
        "Built alongside the book, not bolted on after",
    ],
    "openers": [
        "You build what students actually learn{org_clause}, so your read matters more than mine.",
        "Here is why I am writing you specifically: {role}{org_clause}.",
        "Given your work{org_clause}, you will see in five minutes whether this maps to your standards.",
    ],
    "openers_li": [
        "I saw your curriculum work{org_clause}.",
        "You shape what students actually learn{org_clause}.",
    ],
    "email_bodies": [
        "Hi {first},\n\n{opener}\n\nI wrote {BOOK}, a picture book that teaches 16+ money concepts inside a story instead of a worksheet. It maps to Jump$tart, Common Core Math and ELA, and CEE, and it ships with a zero-prep educator toolkit (lesson plans, discussion guide, assessment). {fact}\n\n{ask}\n\n{sig}",
        "Hi {first},\n\n{opener}\n\n{BOOK} teaches budgeting, comparison shopping, and markdowns through a kid's Sea-Mart trip. A K-5 teacher with 30+ years in the classroom helped shape the lessons. I would value your read on where it maps in a K-5 scope and sequence.\n\n{ask}\n\n{sig}",
    ],
    "linkedin": [
        "Hi {first}, {opener_li} I wrote {BOOK}, a standards-aligned money story with a zero-prep toolkit. Would value your read on where it fits a K-5 scope and sequence. Could I send a copy?",
        "Hi {first}, quick curriculum gut-check. {BOOK} teaches money skills through a story, mapped to Jump$tart, Common Core, and CEE. Would you tell me if it fits your materials? Happy to send a copy.",
    ],
    "ask": "Would you take a look and tell me where it maps in your scope and sequence? Glad to send a copy and the toolkit.",
    "role_default": "curriculum lead",
}
...
def build(contact):
    ...
    # safety net: kill dangling prepositions left when an org clause is empty
    _dangle = re.compile(r"\s+(from|at|with|for|of)([.,])")
    body = _dangle.sub(r"\2", body)
    li = _dangle.sub(r"\2", li)
