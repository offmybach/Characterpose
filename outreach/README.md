...
and grouped by the bespoke email groups defined in the workbook.

There are **12** groups: the 10 defined in the workbook plus two minted from
never-flagged clusters that the original cut missed — **School & district
procurement (bulk/PO buyers)** and **Curriculum & instructional-design
leaders**. Any contact whose `Bespoke Email Group` matches one of these 12 gets
a voice tuned to that audience.
