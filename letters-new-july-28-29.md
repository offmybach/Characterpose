# Letters — New First-Degree Connections (July 28–29)

Two whales off the latest connection screen. Both 1st-degree, so both are DMs — no request
note, no InMail credit.

The other five recent adds are tier-2 or skip: Lauren Saunders (NCLC — adult consumer
...
## 1. 🐋 Briana Walker
*Gatekeeper · connected Jul 28 · 1st-degree*
*MAESP Zone 4 (Eastern Shore) Rep · 2026 NAESP National Outstanding Assistant Principal · Greensboro Elementary, Caroline County*

**The skinny:** The single best fit on the screen, because she sits at the intersection of three things already in the repo. She is the **MAESP Zone 4 rep for the Eastern Shore** — the same association you have nine letters written for — which makes her a distribution node, not just a reader. She is a **2026 NAESP National Outstanding Assistant Principal**, one of ~29 nationally and the first elementary winner ever out of Caroline County. And MAESP named her a **Connected School Leader** specifically for using digital tools, which means the free browser-based toolkit is aimed straight at her stated strength. Greensboro is Eastern Shore, roughly 40 minutes from Lewes and Rehoboth, so the local tie is real. Already a connection — send today.

```
Briana — congratulations on the National Outstanding Assistant Principal award. First elementary winner from Caroline County, which I did not know until I went looking, and now I can't unsee how overdue it was.
...
## 2. 🐋 Lauren Nowacki
*Press / Editor · connected Jul 29 · 1st-degree*
*Money Deputy Editor, WSJ Buy Side · Certified Financial Health Counselor*

**The skinny:** Press whale. Buy Side is the Wall Street Journal's personal-finance
recommendations vertical — the desk that runs holiday gift guides and teach-your-kid
service pieces — and a deputy money editor there assigns and edits that coverage rather
than just filing it. She is also a Certified Financial Health Counselor, so she will judge
the substance, not the cover. The letter is a story pitch, not a toolkit pitch: lead with
the counterintuitive fact, offer the angle, and let the season do the rest. Connected
Jul 29 — the gift-guide window is the reason to move now, not in November.

```
Lauren — a story rather than a pitch, and you can kill it in one line.
