...
> **Recovered 30 Jul 2026** from git history (deleted file). It was the only place
> `Lucky Little Learners`, `Jillian Starr Teaching`, and `Programming Librarian (ALA)`
> were tracked — three verified listicle targets that existed nowhere else in the repo.
> ⚠️ Confirm the phone number and `jb@` address below are still the ones you want
> published before sending; they predate the current contact set.

The single highest-leverage move in the visibility plan (Play 11). Every "best money
books for kids" listicle is what parents read AND what the AI answer engines quote back.
Get on eight of them and you win search + AEO in one stroke.

**The angle that opens the door:** your list is great; here's the one that teaches the
part that comes first. It's a far easier yes than "please add my book," because you're
paying the respect before you ask for anything.

Send these one at a time, personalized. A blast to fifty addresses is a coupon nobody
clips. Ten real emails beat a hundred templated ones.

---

## Before you hit send — the 30-second checklist

1. Read their actual list. Name it in line one. Name one book on it you genuinely like.
2. Swap every `[bracket]`. If a bracket ships, you've lost.
3. Offer the hardback, not a PDF. A book on a desk gets reviewed; a PDF gets a "thanks."
4. One ask per email. The ask is: add it, or take a review copy. Nothing else.
5. Mean the compliment. If you don't rate their list, don't write them.
...
- Your list teaches saving. Can I add the one that teaches spending?
- The kids' money book that goes all the way to the register
- For "[exact post title]" — the one about the checkout line

**Body:**

Hi [First name],

Your roundup — "[exact post title]" — is one parents actually forward to each other.
It's on the short list I trust, and [one specific book on their list] earning a spot on
it is the reason I do.

Quick pitch, no fluff. Every book on your list teaches earning or saving. Lemonade
stands. Piggy banks. Three jars. All of it essential. But a kid spends money years before
they earn a paycheck or open a savings account — usually on a Saturday, at a register,
with a parent standing right there sweating the total.
...
It's a 36-page hardcover, aligned to five standards frameworks (Jump$tart, Common Core
Math & ELA, CEE, FDIC Money Smart), with a free educator toolkit — lesson plans,
discussion guide, the works. A 30-year K–5 teacher and the 2026 EIFLE Educator of the
Year both put their names on it.

If it's a fit for the list, I'd be honored to be on it. Either way, I'll mail you a copy
this week — hardback, to your door, no strings. If it's not for you, no hard feelings;
I'll still be sending people to your list.
...
## Email 2 — the educators & librarians (ALA/FINRA guide, Programming Librarian, teacher blogs)

**Subject line (pick one):**
- For your financial-literacy list: the K–5 book about the checkout line
- A grades 1–5 money book that teaches the part kids do first
- Zero-prep, standards-aligned, and it goes to the register

**Body:**

Hi [First name],

Your guide — "[exact title]" — is the one I point teachers to when they ask where to
start. Thank you for keeping it honest and keeping it current. That's rarer than it should be.

Here's my pitch, teacher to [teacher/librarian]. Every title on your list teaches earning
or saving. Mine teaches spending — the whole transaction, register included — because a
first grader spends money long before they earn it, and that's the money moment they
actually live.

*Clarence Gets a Bargain* (grades 1–5) walks one kid through a single purchase: sale ads,
comparison shopping, a clearance markdown, a coupon at checkout, and sales tax at the end.
It's built around ***Wants vs. Needs*** and aligned to Jump$tart, Common Core Math & ELA,
CEE, and FDIC Money Smart. The free toolkit has zero-prep lesson plans, a discussion guide
with a 21-term glossary, and pre/post assessments —
clarencegetsabargain.com/educator-toolkit.html. Endorsed by a 30-year K–5 veteran and the
2026 EIFLE Educator of the Year.

Want a copy for the collection? I'll get a hardback to your desk this week. No cost, no catch.
...
## Email 3 — the follow-up (one week later, only if no reply)

**Subject:** re: the register book

Hi [First name] — floating this back to the top in case it slipped past the checkout.
Still happy to mail a copy, still mean every nice thing I said about your list. If it's a
no, a one-word reply and I'll stop cluttering your inbox. If it's a maybe, I'll send the book.

Jonathan

---

## The target list (start here)

Personalize each. These are the lists that own the keyword and feed the answer engines.

| Outlet | The list to reference | Lane |
|---|---|---|
| MoneyProdigy | "29 Money Books for Kids (by Age)" | Money blogger |
| MomMoneyMap | "Best Money Books for Kids... 2026" | Money blogger |
| Brightly (readbrightly.com) | "Books to Help Teach Kids About Money" | Publisher/parent |
| That's So Montessori | "35 Financial Literacy Books" | Parent/educator |
| Lucky Little Learners | "Children's Books that Teach Money" | Teacher blog |
| Jillian Starr Teaching | "8 Valuable Children's Books to Teach Money" | Teacher blog |
| Programming Librarian (ALA) | "7 Picture Books to Teach Kids about Money" | Librarian |
| ALA / FINRA LibGuide | "Financial Literacy for Children" collection guide | Librarian |
| US News Money | "10 Best Money Books for Kids" | Journalist |
| My First Nest Egg | "12 Best Books to Teach Young Children About Money" | Parent/edu |

**Cadence:** five a week, personalized, tracked in a simple sheet (sent / opened / replied /
copy mailed). Follow up once at day 7. Then let it rest. A review copy in the mail does more
persuading than a third email ever will.

**One rule:** never fake the compliment and never send the same email twice. The whole
angle only works if you actually respect the list you're asking to join.
