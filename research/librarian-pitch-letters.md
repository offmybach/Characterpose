# Librarian Pitch Letters — Public & School

Drafted July 12, 2026. Companion to `media-pitch-letter.md`.

Two audiences, two letters. The public librarian is buying circulation and
programming. The school librarian is buying curriculum support and a clean
purchase order. Don't send one letter to both; they'll each smell the other
audience in it.

Notes:
- Librarians buy off facts and hate hype. Both letters front-load the
  cataloging data and keep the claims qualified.
- "Age-appropriate" does not appear anywhere below. On purpose.
- Attach nothing. Links carry the freight.

---

## LETTER 1 — Public Library (Children's / Youth Services)

**Subject options:**
1. A money picture book kids check out for the robot (ISBN & LCCN below)
2. Your Financial Literacy Month program, already built — and free

Dear [Name],

Two requests come to your desk all week. A kid wants a robot book. A parent wants "something that teaches money." I wrote the book that answers both in one checkout.

*Clarence Gets a Bargain* is a 36-page picture book, ages 6–10, that follows one kid through one complete purchase: he earns a robot reward, does "shopping homework" in the sale ads, comparison-shops the aisle, finds the clearance markdown, hands over a coupon, pays the sales tax, and watches Mom photograph the receipt before the car leaves the lot. Kids read it as a robot story. Sixteen-plus money concepts come along without announcing themselves, and the back matter holds a 21-term glossary where each definition points back to the page where the term happens in the story.
...
Review copy on request. Thanks for what you do at that desk.
...
## LETTER 2 — School Library / Media Specialist

**Subject options:**
1. A one-class-period read-aloud that covers five standards frameworks (specs below)
2. The money book for the decade before your state's finance requirement kicks in
...
Review copy on request. Thanks for reading.
...
## Do-not-alter list (both letters)

- ISBN, LCCN, Lexile, price: exact as written. Never round $19.99.
- Maryann is 30+ years, never 20+. The letters say "30+ years" — keep the plus sign.
- The first-book claim keeps "to our knowledge."
- No Aisle Five reveal, no last-name wordplay, even if a librarian asks for
  the best scene. Tease the orange stickers.
