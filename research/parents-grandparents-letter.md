# Parents & Grandparents Letter — "Read It WITH Them"

Drafted July 12, 2026. Companion to the media, librarian, and CFP letters.

The pitch: CGB is a read-along by design, not a corner book. The
interruptions are the product. One letter covers both parents and
grandparents; swap the opening line for grandparent-specific sends
(swap at the bottom).

Best uses: email list, insert card in shipped books, handout at readings,
a "note from the author" page, or the base for a newsletter piece.
...
Dear Parents (and Grandparents — don't skim off, this is for you too),
...
You don't need to know anything about finance to do this well. Mom explains everything to Clarence in the book — sale ads, clearance, markdowns, sales tax — so your only job is to read her lines like you knew it all along. I wrote you the script. Take the credit.
...
- **"Guess the Price" (page 28).** After dinner, somebody shares a deal they got that day and everyone guesses what it cost. Clarence guesses last and lowest, every time. Three players minimum. Grandma counts.

Now, grandparents — your section.

You clipped coupons back when it was a survival skill, not a hobby. You remember layaway. You know what your first paycheck was and exactly what it wouldn't cover. Those stories are the best financial curriculum a kid will ever get, and they need somewhere to land. Fifteen minutes with this book gives them a runway: every page has a "that reminds me of the time…" waiting in it. No batteries, no screen, no assembly — a gift you do with them instead of one you watch them carry off to their room.
...
The whole book runs 15 to 20 minutes out loud. Your kid will reread it alone afterward — they always do, usually starting the same night. Fine. But the first read belongs to both of you. Don't give that one away.
...
## Grandparent-specific opening swap

Replace the first two paragraphs with:

"Grandparents buy a lot of books. Most get carried off to a bedroom and
you never hear another word. I wrote one that doesn't work that way — it
needs you in the room.

*Clarence Gets a Bargain* carries a reading level of Lexile AD 620L. The
AD stands for 'Adult Directed' — the book industry's own label for a book
meant to be read WITH a child, not handed to one. You're not optional
equipment here. You're cast."
...
- AD 620L stays estimated in formal contexts ("Est. Lexile AD 620L" on
  spec sheets); in this letter's conversational frame it reads clean, but
  never drop the "Est." where specs are quoted.
- Page references (6, 24, 27, 28) are real. Don't shift them.
- Page 24 is described, not quoted. If quoting, use the book text verbatim.
- No Aisle Five reveal. "In the middle of Aisle Five" teases the location
  only; keep it that way.
- Maryann/endorsements aren't in this letter on purpose — parents don't
