...
## The thesis these are built on

Five things, in this order. Every letter uses at least three.

1. **Spending comes before saving.** Not a topic claim, a sequence claim. A six-year-old has
   no savings rate. She has stood at a register holding money.
2. **Idea to post-receipt.** The book follows one purchase the whole way — wanting the thing,
   earning it, the sale ads, the aisle, the markdown, the coupon, the sales tax, the receipt,
   and living with what you bought. Read every title on the ABA Foundation's list; not one
   does the full arc.
3. **First purchase makes them a consumer.** The moment money changes hands a child is a
   party to a transaction, with rights nobody tells them about.
4. **Smuggled, not taught.** Sixteen-plus concepts, none announced. Nobody in the book says
   the word "budget."
5. **They don't know they've been schooled until the glossary.** Twenty-one terms in the back,
   each page-referenced to where it actually happened. The book confesses on the last page —
   which is both the proof the smuggling worked and the best single line for a cold letter.
   The site already says it well at `index.html`: *"they're consumers now. Clueless ones, most
   likely — but consumers all the same… before they realize they've been schooled."*

**⚠️ NGPF conflict:** #5 Tim Ranzetta and #11 Yanely Espinal are the same building. Send
Ranzetta this week, hold Espinal for week two.
...
**Highest score on the entire list.** Was missed in the original pass — do not miss her again.
...
## 4. 🐋 Daniel Hagadorn — 110
*Founder, 360 Parenting · Speaker, author, podcaster · 1st-degree*
Published email on his headline: `dh@PK4L.com` — LinkedIn first, email as backup.
...
```
Tim — NGPF owns 9-12 and does it better than anyone, so this is not a pitch into your territory. It is a question about the floor beneath it.
...
## 11. 🐋 Yanely Espinal — 102
*NGPF — Director of Educational Outreach · 2nd-degree · InMail*
**⏸ HOLD until week two.** Tim Ranzetta (#5) goes this week and they work together.
...
**Tier C — deadpan.** Deeper version of this is in `letters-cfpb-consumer-rights.md`.
...
## 16. 🐋 Tiffany "The Budgetnista" Aliche — 100
...
```
Sandy — FCCLA members are a decade older than my readers, so this is not a curriculum pitch. It is a service-project one, and I think it's a good one.
...
```
Stacey — you design and produce books for other authors, which makes you one of very few people I could ask this of honestly: does mine look like it was made by someone who knew what he was doing?
...
All 25 in one week is fine on invite limits — these are messages to existing connections, not
invites — but replies are the point, so front-load the ones most likely to answer.

**Day 1–2:** Roda Ducommun (22), Cinders McLeod (12), Tami Lehman-Wilzig (2), ML Bruin (19),
Nicolle Hood (24) — peers and near-peers, warmest.
**Day 2–3:** Linda Simpson (3), Daniel Hagadorn (4), Paula Pant (6), Kim Childress (7),
Rishi Vamdatt (15), Stacey Aaronson (23).
**Day 3–4:** Alex Goldmark (1), Michelle Singletary (10, InMail), Tiffany Aliche (16),
Neale Godfrey (8), Tom Henske — next batch.
**Day 4–5:** the institutional ones, which reply slowest and cost nothing to have pending —
Chrisler (9), Leslie Jones (13), Worthey (14), Haralson (17), Godat (21), Field (25),
Ranzetta (5), Spavone (20), Lusardi (18).

**Hold to week two:** Yanely Espinal (11). Same building as Ranzetta.
